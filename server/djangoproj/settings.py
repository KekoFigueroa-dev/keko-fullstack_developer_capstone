...
CSRF_TRUSTED_ORIGINS = ['https://thenaturalis-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai','https://github.com/KekoFigueroa-dev/keko-fullstack_developer_capstone.git']
